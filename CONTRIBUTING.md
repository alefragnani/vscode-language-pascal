...
Unsure where to begin contributing? You can start by looking through the [`good first issue`](https://github.com/alefragnani/vscode-language-pascal/labels/good%20first%20issue) issues.
